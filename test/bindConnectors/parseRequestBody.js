...
describe('#parseRequestBody', function () {
    ...
    it('json decode should fail and return rawBody as body when content-type is application/json but json is invalid', function() {

        var http = {
    		"headers": {
    			"Content-Type": ["application/json"]
    		},
    		"body": new Buffer('{"id": 123,"name": "Chris Houghton""test": invalidVar}').toString('base64'),
    		"form": []
    	};
    	...
    	assert.notEqual(originalBody, newHttp.body);
    	assert.deepEqual(newHttp.body, '{"id": 123,"name": "Chris Houghton""test": invalidVar}');
    });
