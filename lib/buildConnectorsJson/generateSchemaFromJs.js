...
function generateSchemaObject (rawObject, title) {
	...
	//Allow `additionalProperties: true` if 'object' is one of the types
	if (_.isArray(rawObject.type) && rawObject.type.includes('object')) {
		if (_.isBoolean(additionalProperties)) {
			validObject.additionalProperties = additionalProperties;
		}
	}
