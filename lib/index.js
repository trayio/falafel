...
// Export validation utilities for use in test runners and CI
module.exports.validateInputTypes = validateInputTypes.validateInputTypes;
module.exports.validateSchemaConsistency = validateInputTypes.validateSchemaConsistency;
module.exports.validateSchemaDefaults = validateInputTypes.validateSchemaDefaults;
module.exports.validateValue = validateInputTypes.validateValue;
