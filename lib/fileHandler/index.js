	...
	*/
	var upload = function (params) {
		...
		return when.promise(function (resolve, reject) {
			...
			//Get mimeType
			var mimeType = params.contentType || mime.getType(params.name);
	...
	*/
	var streamMPUpload = function (params) {
		...
		return when.promise(function (resolve, reject) {
			...
			if (!_.isUndefined(params.length)) {
				var fileSize = uploadParams.ContentLength = params.length;
			...
			var passThroughStream = new PassThrough({ highWaterMark: uploadOptions.partSize });
