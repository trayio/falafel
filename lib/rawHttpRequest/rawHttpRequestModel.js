...
const formatFailure = require('./formatFailure.js');
...
module.exports = {
	...
	url: (params) => {
		...
		*/
		return endpoint ? (endpoint[0] === '/' ? endpoint : `/${endpoint}`) : '';
	},
	...
	*/
	...
	//Surface the response headers on API response errors
	afterFailure: formatFailure,
};
